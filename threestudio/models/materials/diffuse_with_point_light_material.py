    ...
    def forward(
        ...
        **kwargs,
        ...
        diffuse_light: Float[Tensor, "B ... 3"] = (
            dot(shading_normal, light_directions).clamp(min=0.0) * diffuse_light_color.to(light_directions)
        )
        textureless_color = diffuse_light + ambient_light_color.to(light_directions)
